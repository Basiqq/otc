...
local walkDirs = {nw = 7, sw = 6, se = 5, ne = 4, west = 3, south = 2, east = 1, north = 0}

function genericStep(value, retries, prev, direction)
...
CaveBot.registerAction("stepNorth", "green", function(value, retries, prev)
  return genericStep(value, retries, prev, walkDirs.north)
end)

CaveBot.registerAction("stepSouth", "green", function(value, retries, prev)
  return genericStep(value, retries, prev, walkDirs.south)
end)

CaveBot.registerAction("stepWest", "green", function(value, retries, prev)
  return genericStep(value, retries, prev, walkDirs.west)
end)

CaveBot.registerAction("stepEast", "green", function(value, retries, prev)
  return genericStep(value, retries, prev, walkDirs.east)
end)

CaveBot.registerAction("diagNW", "green", function(value, retries, prev)
  return genericStep(value, retries, prev, walkDirs.nw)
end)

CaveBot.registerAction("diagNE", "green", function(value, retries, prev)
  return genericStep(value, retries, prev, walkDirs.ne)
end)

CaveBot.registerAction("diagSW", "green", function(value, retries, prev)
  return genericStep(value, retries, prev, walkDirs.sw)
end)

CaveBot.registerAction("diagSE", "green", function(value, retries, prev)
  return genericStep(value, retries, prev, walkDirs.se)
end)
