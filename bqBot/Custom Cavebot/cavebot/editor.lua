...
CaveBot.Editor.setup = function()
  ...
  registerAction("goto", "go to", {
    ...
    registerAction("diagnw", "step nw", {
    value=function() return posx() .. "," .. posy() .. "," .. posz() end,
    title="step to nw",
    description="step to NW (x,y,z)",
    multiline=false,
    validation="^\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+),?\\s*([0-9]?)$"
  })
  registerAction("diagne", "step ne", {
    value=function() return posx() .. "," .. posy() .. "," .. posz() end,
    title="step to ne",
    description="step to NE (x,y,z)",
    multiline=false,
    validation="^\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+),?\\s*([0-9]?)$"
  })
  registerAction("diagse", "step se", {
    value=function() return posx() .. "," .. posy() .. "," .. posz() end,
    title="step to ",
    description="step to SE (x,y,z)",
    multiline=false,
    validation="^\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+),?\\s*([0-9]?)$"
  })
  registerAction("diagsw", "step sw", {
    value=function() return posx() .. "," .. posy() .. "," .. posz() end,
    title="step to swsw",
    description="step to SW (x,y,z)",
    multiline=false,
    validation="^\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+),?\\s*([0-9]?)$"
  })
 registerAction("stepnorth", "step north", {
    value=function() return posx() .. "," .. posy() .. "," .. posz() end,
    title="step to north",
    description="step to north (x,y,z)",
    multiline=false,
    validation="^\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+),?\\s*([0-9]?)$"
  })
 registerAction("stepsouth", "step south", {
    value=function() return posx() .. "," .. posy() .. "," .. posz() end,
    title="step to south",
    description="step to south (x,y,z)",
    multiline=false,
    validation="^\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+),?\\s*([0-9]?)$"
  })
 registerAction("stepwest", "step west", {
    value=function() return posx() .. "," .. posy() .. "," .. posz() end,
    title="step to west",
    description="step to west (x,y,z)",
    multiline=false,
    validation="^\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+),?\\s*([0-9]?)$"
  })
 registerAction("stepeast", "step east", {
    value=function() return posx() .. "," .. posy() .. "," .. posz() end,
    title="step to east",
    description="step to east (x,y,z)",
    multiline=false,
    validation="^\\s*([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+),?\\s*([0-9]?)$"
  })
